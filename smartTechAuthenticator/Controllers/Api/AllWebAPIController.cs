...
namespace smartTechAuthenticator.Controllers.Api
{
    public class AllWebAPIController : ApiController
    {
                    ...
                    employeelist = (from cate in appDB.CustomerInfo.Where(x => x.AddedBy == res.AddedBy && x.UserType == (UserType)3)
                                    select new CustomerInfoViewModel
                                    {
                                       ...
                                       // AddedBy = cate.AddedBy,
                                        AddedBy = "" + appDB.CustomerInfo.Where(x => x.Id.ToString() == cate.AddedBy).FirstOrDefault().FName + " " + appDB.CustomerInfo.Where(x => x.Id.ToString() == cate.AddedBy).FirstOrDefault().LName + " ",
                    ...
                    EmpData = (from comp in appDB.CustomerInfo.Where(x => x.Id == res.Id)
                               select new CustomerInfoViewModel
                               {
                                  ...
                                  // AddedBy = comp.AddedBy,
                                   ...
                                   Email = comp.Email,
                                   Photo = comp.Photo,
                                  //FName = appDB.CustomerInfo.Where(x => x.Id == new Guid(comp.AddedBy)).FirstOrDefault().FName,
                                  //LName = appDB.CustomerInfo.Where(x => x.Id == new Guid(comp.AddedBy)).FirstOrDefault().LName,
                                   AddedBy = "" + appDB.CustomerInfo.Where(x => x.Id.ToString() == comp.AddedBy).FirstOrDefault().FName + " " + appDB.CustomerInfo.Where(x => x.Id.ToString() == comp.AddedBy).FirstOrDefault().LName + " ",
                ...
                if (res.Id != null && res != null)
                {
                    ...
                    EmpData = (from comp in appDB.CustomerInfo.Where(x => x.Id == res.Id)
                               select new CustomerInfoViewModel
                               {
                                   ...
                                   MobileNo = comp.MobileNo,
                                   Photo = comp.Photo,
                                   //FName = appDB.CustomerInfo.Where(x => x.Id.ToString() == comp.AddedBy).FirstOrDefault().FName,
                                   //LName = appDB.CustomerInfo.Where(x => x.Id.ToString() == comp.AddedBy).FirstOrDefault().LName,
                    ...
                    //var AddedBy = EmpData.FName + " " + EmpData.LName;
        ...
        private IHttpActionResult Ok(CustomerInfoViewModel empData, object addedBy)
        {
        ...
        public IHttpActionResult GetSubmittedFormList(HtmlResponseDataViewModel res)
        {
            List<HtmlResponseDataViewModel> formlist = new List<HtmlResponseDataViewModel>();
        ...
        [HttpPost]
        [Route("api/WebAPI/GetPlanList")]
        public IHttpActionResult GetPlanList(PlansViewModel res)
        {
            List<PlansViewModel> Planlist = new List<PlansViewModel>();

            try
            {
                if (res != null)
                {
                    Planlist = (from data in appDB.Plans
