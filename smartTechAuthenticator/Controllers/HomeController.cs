 ...
 public class HomeController : Controller
    {
        ...
        public JsonResult UpdateSubmitformView(string formdata, string formid, string userid)
        {
            ...
            try
            {
                // Remove previous entries with the same FormId and UserId
                var data = context.HtmlResponseData.Where(x => x.FormId == formid && x.UserId == userid).ToList();
                context.HtmlResponseData.RemoveRange(data);
                ...
                // Save changes after both operations
                context.SaveChanges();
                res.Data = 1;
            }
            catch (Exception ex)
            {
                ...
                // You may also want to provide more detailed error information in your response
